    ...
    for word in new_text:
        while t < 100:
            ...
            if POS == 'NOUN':
                ...
                continue
    print(ADJF_list, ADJS_list, ADVB_list, PREP_list, COMJ_list, PRCL_list, INTJ_list)

    return ANIM_NOUN_list, INAN_NOUN_list, TRAN_VERB_list, INTR_VERB_list, ADJF_list, ADJS_list, COMP_list, INFN_list, PRTF_list, PRTS_list, GRND_list, NUMR_list, ADVB_list, NPRO_list, PRED_list, PREP_list, COMJ_list, PRCL_list, INTJ_list
...
ANIM_NOUN_list, INAN_NOUN_list, TRAN_VERB_list, INTR_VERB_list, ADJF_list, ADJS_list, COMP_list, INFN_list, PRTF_list, PRTS_list, GRND_list, NUMR_list, ADVB_list, NPRO_list, PRED_list, PREP_list, COMJ_list, PRCL_list, INTJ_list = reading('D:\\python\\Telegram Bot 2\\new  2.txt')
